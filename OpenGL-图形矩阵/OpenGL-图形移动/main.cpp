...
//    shaderManager.UseStockShader(GLT_SHADER_IDENTITY,vRed);
    ...
    //4*4 矩阵
    M3DMatrix44f mTransform, mRoration, mFinal;
    
    //平移
    m3dTranslationMatrix44(mTransform, xpos, ypos, 0);
    
    //z轴旋转
    static GLfloat zrora = 0.0f;
    
    //旋转
    //m3dDegToRad 角度转弧度
    m3dRotationMatrix44(mRoration, m3dDegToRad(zrora), 0, 0, 1.0f);
    
    zrora += 5.0f;
    
    //矩阵相乘
    m3dMatrixMultiply44(mFinal, mTransform, mRoration);
    
    //渲染
    shaderManager.UseStockShader(GLT_SHADER_FLAT,mFinal,vRed);
