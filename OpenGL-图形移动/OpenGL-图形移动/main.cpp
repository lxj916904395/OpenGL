...
void SpecialKeys(int key, int x, int y){
    GLfloat p1x = vVerts[0];
    GLfloat p1y = vVerts[1];
    ...
    vVerts[3] = p1x+2*blockSize;
    vVerts[4] = p1y;
    
    vVerts[6] = p1x+2*blockSize;
    vVerts[7] = p1y+2*blockSize;
    
    vVerts[9] = p1x;
    vVerts[10] = p1y+2*blockSize;
